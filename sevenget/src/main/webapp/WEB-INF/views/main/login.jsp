        ...
        var BV = new $.BigVideo({useFlashForFirefox:false, container:$('#videoEle')});
            ...
            if (mobilecheck()) {
               /*  BV.show('./file/SampleVideo.jpg'); */
                ...
                BV.show(
                    { type: "video/mp4",  src: "../resources/img/XoP2EV.mp4", doLoop:true },
                    { type: "video/webm", src: "../resources/img/XoP2EV.webm", doLoop:true },
                    { type: "video/ogv",  src: "../resources/img/XoP2EV.ogv", doLoop:true }
                );
